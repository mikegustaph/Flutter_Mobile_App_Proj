...
import 'package:rushbuy/ui/widgets/cropped_container.dart';
...
class _LoginPageState extends State<Login> with TickerProviderStateMixin {
  ...
  Future<void> getLoginUser() async {
    ...
    apiBaseHelper.postAPICall(getUserLoginApi, data).then((getdata) async {
      ...
      if (!error) {
        ...
        userProvider.setType(loginType ?? "");
                ...
                Navigator.pushAndRemoveUntil(
                    ...
                    MaterialPageRoute(
                        builder: (BuildContext context) =>
                            widget.classType ?? const Dashboard()),
                    (route) => false);
              }
            });
          });
  ...
  getSignUpText() {
    return Padding(
      padding: const EdgeInsetsDirectional.only(
          bottom: 20.0, start: 25.0, end: 25.0, top: 30.0),
      child: Row(
      ...
      child: SizedBox(
        ...
        child: SvgPicture.asset(
          brightness == Brightness.dark
              ? 'assets/images/dark_loginlogo.svg'
