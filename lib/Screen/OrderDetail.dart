...
import 'package:rushbuy/Model/Order_Model.dart';
import 'package:rushbuy/Screen/Review_Gallary.dart';
import 'package:rushbuy/Screen/Review_Preview.dart';
...
class StateOrder extends State<OrderDetail>
  ...
  productItem(OrderItem orderItem, OrderModel model) {
    ...
    print(
        "order product type****${orderItem.productType}****${orderItem.downloadAllowed}*****$cDate");
                ...
                Row(
                  ...
                  children: [
                    ...
                    if (!orderItem.listStatus!.contains(DELIVERD) &&
                        ...
                        orderItem.canclableTill != orderItem.status)
                      Padding(
