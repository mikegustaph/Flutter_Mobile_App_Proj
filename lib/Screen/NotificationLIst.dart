    ...
    return GestureDetector(
      onTap: () async {
        if (model.type == "products") {
          ...
          Navigator.push(context, (CupertinoPageRoute(builder: (context) => const MyWallet())));
        } else if (model.type == 'order') {
          Navigator.push(context, (CupertinoPageRoute(builder: (context) => const MyOrder())));
          ...
          Navigator.push(
              context, CupertinoPageRoute(builder: (context) => const CustomerSupport()));
                        ...
                        Navigator.of(context).push(PageRouteBuilder(
                            ...
                            pageBuilder: (BuildContext context, _, __) {
                              return AlertDialog(
                                ...
                                content: Hero(
                                    tag: "$index${model.id!}",
                                    child: networkImageCommon(model.img!, 150, false)
                                    /*CachedNetworkImage(
                                    imageUrl: model.img!,
                                    fadeInDuration:
  ...
  Future<void> getNotification() async {
    ...
    if (_isNetworkAvail) {
      try {
        ...
        apiBaseHelper.postAPICall(getNotificationApi, parameter).then((getdata) {
          ...
          if (!error) {
            ...
            if ((offset) < total) {
              ...
              tempList = (data as List).map((data) => NotificationModel.fromJson(data)).toList();
